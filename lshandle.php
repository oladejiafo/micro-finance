 ...
 if (isset($_POST['submit']))
 {
   switch ($_POST['submit'])
   {
     case 'Approve Lease':
      if ($id)
      {
        $query_update = "UPDATE `lease application` SET `Status`='Approved',`Personal_Remark`='$personal_remark',`Income_Remark`='$income_remark',`Employment_Remark`='$employment_remark',`NK_Remark`='$nk_remark',`Bank_Remark`='$bank_remark' WHERE `ID` = '$id'";
     ...
     case 'Disapprove Lease':
      if ($id)
      {
        $query_update = "UPDATE `lease application` SET `Status`='Disapproved',`Personal_Remark`='$personal_remark',`Income_Remark`='$income_remark',`Employment_Remark`='$employment_remark',`NK_Remark`='$nk_remark',`Bank_Remark`='$bank_remark' WHERE `ID` = '$id'";
        $result_update = mysqli_query($conn,$query_update);
