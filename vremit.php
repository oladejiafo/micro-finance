...
<TABLE width='100%' border='1' cellpadding='1' cellspacing='1' align='center' bordercolor="#005B00">
 ...
 $limitvalue = $page * $limit - ($limit);  
    ...
    $query="SELECT concat(`Dob_Day`,'/',`DoB_Month`,'/',`DoB_Year`) as date,Command,Amount,Bank,`Amount Remitted`,`ID`,`Confirmed` FROM `Revenue` order by `DoB_Day`,`DoB_Year` desc LIMIT $limitvalue, $limit";
