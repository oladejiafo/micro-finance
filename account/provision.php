...
$sql="SELECT * FROM `cash` WHERE `ID`='$id' and `Classification` = '$class' and `Date`='$date' order by `Date` desc";
...
<div class='row' style="background-color:#394247; width:100%" align="center"><b>
  <font face="Verdana" color="#FFFFFF" style="font-size: 16pt">Loans Provision</font></b>
</div>
...
<div align="leftt" style="margin-left:20px;font-size: 12px" class="agileinfo_mail_grids">
	...
	<select  name="classification" class="input__field input__field--chisato" placeholder=" " value="<?php echo $row['Classification']; ?>" required>  
          <?php  
           ...
           $sql = "SELECT * FROM `heads` where `Code` like '45%'";
