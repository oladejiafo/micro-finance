...
define("EW_REPORT_CONN_DB", "medics", TRUE);
...
define("EW_REPORT_RANDOM_KEY", 'wqvoWdBQb7&yEX%p', TRUE); // Random key for encryption
define("EW_REPORT_CHART_SCRIPT", 'rptewchartfcf.php', TRUE);
