...
<TABLE width='100%' border='1' cellpadding='1' cellspacing='1' align='center' bordercolor="#ccCCcc" id="table2">
 <?php
   ...
   $result = mysqli_query ($conn,"SELECT distinct `Category` FROM `heads` where `Category` in ('Fixed Assets','Current Assets','Current Liabilities')"); 
...
$ttt=0;
    ...
    {	
      ...
      $result2 = mysqli_query ($conn,"SELECT `Description`,`Category` FROM `heads` where `Category`= '$cat'"); 
