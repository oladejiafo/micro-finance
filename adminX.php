...
$a_users = array(1 => "Administrator", "Manager", "Personnel", "Account", "Medical");
...
<div align="center">
	<table border="0" width="100%" id="table1" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0">
		<tr>
			<td style="text-align: left; margin-left: 10"><b>
			<font face="Verdana" size="4" color="#707070">&nbsp;Administration Area</font></b></td>
		</tr>
		<tr>
			<td bgcolor="#707070">
		...
		<tr>
			<td style="text-align: left; margin-left: 10; padding-left: 20px">
			<table border="1" width="99%" id="table2">
				<tr>
					<td width="33%" bordercolor="#009900" bgcolor="#F0FFC1">&nbsp;</td>
					<td width="33%" bordercolor="#009900" bgcolor="#F0FFC1">&nbsp;</td>
					<td width="33%" bordercolor="#009900" bgcolor="#F0FFC1">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
				  <td bordercolor="#009900" bgcolor="#F0FFC1" valign="top">
					<div align="center">
						<table border="0" width="99%" cellspacing="1" id="table3">
							<tr>
								<td width="17%">
							...
							<tr>
								<td>&nbsp;</td>
								<td><?php
  echo '<h3><a href ="useraccount.php"> Add User </a></h3>';
?></td>
							</tr>
						</table>
					</div>				  </td>
				  <td bordercolor="#009900" bgcolor="#F0FFC1" valign="top">
					<div align="center">
						<table border="0" width="99%" cellspacing="1" id="table4">
							<tr>
							...
							<tr>
								<td>&nbsp;</td>
								<td><?php
  echo "<h3><a href ='listing.php'> List of Users </a></h3>";
?></td>
							</tr>
						</table>
					</div>				  </td>
					<td bordercolor="#009900" bgcolor="#F0FFC1" valign="top">
					<div align="center">
						<table border="0" width="99%" cellspacing="1" id="table5">
							<tr>
							...
							<tr>
								<td>&nbsp;</td>
								<td><?php
   echo "<h3><a href ='tableupdates.php'> Tables Update </a></h3>";
?></td>
							</tr>
						</table>
					</div>					</td>
